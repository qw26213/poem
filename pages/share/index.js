...
Page({
    ...
    setName: function(context) {
        ...
        context.fillText(app.globalData.userInfo.nickName, size.w / 2, 113);
        context.stroke();
    },
    setText1: function(context) {
        var size = this.setCanvasSize();
        context.setFontSize(12);
        context.setTextAlign("center");
        context.setFillStyle("#666666");
        context.fillText("青春年少、意气风发", size.w / 2, 140);
        context.stroke();
    },
    setText2: function(context) {
        ...
        context.setTextAlign("center");
        context.setFillStyle("#333333");
        context.fillText("“跟我一起品味古诗词，交流读诗心得！”", size.w / 2, 350);
        context.stroke();
    },
    setText3: function(context) {
        ...
        context.fillText("来【诗词地带】读古诗词", size.w / 2, 309);
        context.stroke();
    },
    drawBusinessImage: function() {
        var size = this.setCanvasSize();
        ...
        context.save();
        context.drawImage('../../image/erwm.jpg', size.w/2 - 50, 160, 100, 100); //二维码，宽度100，居中
        this.setName(context);
        this.setText2(context);
        this.setText1(context);
